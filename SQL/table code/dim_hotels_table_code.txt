CREATE TABLE dim_hotels (property_id int,property_name varchar(30),category varchar(30),city varchar(30));

INSERT INTO dim_hotels(property_id,property_name,category,city) VALUES 
